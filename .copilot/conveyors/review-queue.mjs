...
//   run_conveyor({ name: "review-queue", budget: 10000, args: <parsed /tmp/prs.json> })
//
...
const opts = conveyorArgs && typeof conveyorArgs === "object" && !Array.isArray(conveyorArgs) ? conveyorArgs : {};
