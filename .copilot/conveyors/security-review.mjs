...
//
//   run_conveyor({ name: "security-review", budget: 6000 })                    // local changes
//   run_conveyor({ name: "security-review", args: { root: "src/" } })          // subtree
//   run_conveyor({ name: "security-review", args: ["src/a.js", "src/b.js"] })  // explicit files
export const meta = {
