...
const HOME = homedir();
export const plansDir = () => process.env.CWF_PLANS_DIR || join(process.env.CWF_WORKFLOWS_DIR || join(HOME, ".copilot/workflows"), "plans");

/** @param {{ source: string, hostPath?: string|null, args: unknown, cfg: any, plannedAgents: number }} input */
export function persistWorkflowPlan(input) {
...
/** @param {string} planId */
export function loadWorkflowPlan(planId) {
