 ...
 * @module sessions
 *
 * Disposal of the Copilot sessions a workflow run creates. Every subagent is a full `copilot`
 ...
 * failed is preserved for inspection. Set `CWF_KEEP_SESSIONS=1` to keep every child session.
 */
...
export const keepSessions = () => process.env.CWF_KEEP_SESSIONS === "1";
